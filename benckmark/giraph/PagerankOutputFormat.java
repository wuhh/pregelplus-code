...
public class PagerankOutputFormat extends
	TextVertexOutputFormat<IntWritable, PagerankWritable, NullWritable> {
	...
	protected Text convertVertexToLine(
		Vertex<IntWritable, PagerankWritable, NullWritable, ?> vertex)
		throws IOException {
	    ...
	    str.append(vertex.getValue().getPageRank());
