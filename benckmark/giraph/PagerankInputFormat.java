...
public class PagerankInputFormat extends
	TextVertexInputFormat<IntWritable, PagerankWritable, NullWritable> {
	...
	@Override
	protected PagerankWritable getValue(String[] tokens) throws IOException {
	    return new PagerankWritable(1.0);
	}
